...
def check_drinks(drink_name, drink_ingredients):
    ...
    drink_type = 'Mocktail' if ALCOHOLS.isdisjoint(
        drink_ingredients) else 'Cocktail'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    # dish_category =
    categories_map = {"VEGAN": VEGAN, "VEGETARIAN": VEGETARIAN,
    ...
    for name, category in categories_map.items():
        if dish_ingredients_set.issubset(category):
            category_name = name
